...
def compute_confidence():
    ...
    # Pipeline freshness — kept as an explicit component so a future
    # stale/failed-fetch scenario has a clear place to reduce this score.
    # NOTE: now that fetch and aggregation are separate scripts, this could
    # be made more meaningful by checking a timestamp fetch_activities.py
    # writes on success, rather than assuming this run implies a fresh fetch.
    pipeline_pts = 15
    score += pipeline_pts
